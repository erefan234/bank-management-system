...
public class Fastcash extends JFrame implements ActionListener{
    ...
    JButton deposit,fastcash,cashwithdraw,ministate,exit,pinchange,benquiry,withdraw; 
    String pinnumber;
    Fastcash(String pinnumber){
        ...
        cashwithdraw = new JButton("Rs.1000");
     ...
     public void actionPerformed(ActionEvent ae){
         if (ae.getSource() ==exit){
             ...
             Conn c= new Conn();
             try{
                 ResultSet rs = c.a.executeQuery("select * from bank where pin= '"+pinnumber+"'");
                 int balance = 0;
                 while(rs.next()){
